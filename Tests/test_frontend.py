...
class TestImageUpload(unittest.TestCase):
    ...
    def test_upload_images(self):
        ...
        for i in range(num_tabs):
            ...
            driver.get('file://' + os.path.abspath('./frontend/index.html'))

            # Upload images
            for image in image_files:
                self.upload_image(driver, os.path.join(
    ...
    def upload_image(self, driver, image_path):
        ...
        select_element = driver.find_element(
            By.XPATH, "//div[@id='imageFilters']//select")
    ...
    # Find the submit button element
        ...
        image_path = "./Tests/Images/image1.jpg"
        wait_time = 0
        ...
        while not os.path.exists(image_path):
            ...
            if wait_time >= max_wait_time:
                self.fail(f"Image download took too long. Expected file '{
                          image_filename}' was not found.")
